...
public class SillasVoladoras extends Decorator implements UsoAtracción, ControlViajes, SupervisiónViajes
{
	 ...
	 */
	public SillasVoladoras ( int maxPlazas, ControlPulseras cPulseras, Atraccion a)
	{
		super(a);
		this.cerrar = false;
		this.barrera = false;
	...
	public void setDificulty() {
		System.out.println("velocidad regular");
	}
}
